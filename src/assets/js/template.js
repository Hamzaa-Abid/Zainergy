...
(function($) {
  ...
  // close sidebar when click outside on mobile/table    
    ...
    $("#sidebarCollapse").click(function(){
      $("body").toggleClass("close-infobar");
    });


    $('.maximize-card').click(function(){
      $(this).parents('.card').toggleClass("full-screen");
      $('.minimize-card').toggle();
      $('.maximize-card').toggle();
      //  $(this).html('<i data-feather="minimize-2"></i>');
      //  feather.replace();
    });
